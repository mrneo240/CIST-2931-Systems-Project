...
<html>
    <head>
        ...
        <title>Change Patient's Appointment</title>
        <% 
    ...
    <body><div id="wrapper">
        ...
        <h1 style="padding-left: 20px">Change your Appointment!</h1>
        <main>
            ...
            <tr>
                <th><label for="dateTime">Appointment Date and Time</label></th>
                <td><input type="text" name="dateTime" placeholder="Enter the Date and Time you desire"></td>
            </tr>
            <tr>
                <th><label for="chooseDentist">Your Dentist</label></th>
            ...
            <div id="displaybuttons">
                <div class="displaybutton">                 
                        <input type="submit" name="updateAppointment" value="DONE">                  
                </div>
                <div class="displaybutton">
